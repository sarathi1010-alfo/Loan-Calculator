...
export const metadata: Metadata = {
  title: "Comprehensive EMI FAQ - Frequently Asked Questions | EMI Calculator Pro",
  description: "Find answers to 50+ common questions about EMIs, home loans, car loans, personal loans, interest rates, and amortization schedules.",
};
    ...
    <div className="container mx-auto px-4 py-8 md:px-8 lg:py-12 max-w-4xl">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-muted-foreground">
          Everything you need to know about EMIs, loans, interest rates, and amortization.
        </p>
      </div>
          ...
          <section key={idx}>
            ...
            <div className="space-y-6">
              {category.questions.map((faq, qIdx) => (
                <div key={qIdx} className="bg-card p-6 rounded-lg shadow-sm border">
