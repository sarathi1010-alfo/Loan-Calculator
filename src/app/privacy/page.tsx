...
export const metadata: Metadata = {
  ...
  description:
    "Read our privacy policy to understand how we collect, use, and protect your personal information when using our EMI calculator tools.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:px-8 lg:py-12 max-w-4xl">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none text-muted-foreground">
        ...
        <p>
          Welcome to LoanCalculatorHub. We respect your privacy and are
        ...
        <p>
          Our application is designed as a client-side tool. This means that all
          loan calculations (EMI, Principal, Interest, etc.) are performed
          entirely within your web browser.
          <strong>
            {" "}
            We do not collect, store, or transmit your financial input data to
            our servers.
          </strong>
        </p>
        <p>
          However, we may automatically collect certain non-personally
          identifiable information, such as your IP address, browser type,
          operating system, referring URLs, and information about your
          interaction with our website using cookies and similar tracking
          technologies for analytics and ad-serving purposes.
        </p>
        ...
        <p>
          ...
          as a third-party vendor, uses cookies to serve ads based on a user's
          ...
          users based on their visit to our sites and/or other sites on the
          Internet.
        </p>
        <p>
          Users may opt-out of personalized advertising by visiting Google's{" "}
          <a
            href="https://myaccount.google.com/ad-settings"
            target="_blank"
            rel="nofollow"
