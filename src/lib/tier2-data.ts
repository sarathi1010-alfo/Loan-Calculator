...
export const TIER2_PAGES: Tier2Page[] = [
  // Loan Types
  {
    ...
    faqs: [
      ...
      { question: "Can I use this for pre-construction loans?", answer: "Yes, you can use this to estimate your post-moratorium EMI once the full loan amount is disbursed." }
    ]
  },
  {
    ...
    faqs: [
      ...
      { question: "Do personal loans have prepayment fees?", answer: "Yes, many banks charge a penalty (usually 2-5%) for closing a personal loan early. Check your agreement details." }
    ]
  },
  {
    ...
    faqs: [
      ...
      { question: "Should I choose a 7-year car loan?", answer: "While a 7-year tenure makes the EMI very affordable, you will pay much more interest and might find yourself 'underwater' on the car loan." }
    ]
  },
  {
    ...
    faqs: [
      ...
      { question: "Can I pay interest during the course?", answer: "Yes, paying simple interest during the moratorium period is highly recommended as it prevents interest capitalization and lowers your future EMI." }
    ]
  },
  ...
  // Scenarios
  {
    ...
    faqs: [
      ...
      { question: "Is ₹5 Lakh enough for a home renovation?", answer: "It depends on the scope, but ₹5 Lakh is a common amount for bathroom or kitchen remodels. Use this calculator to plan your budget." }
    ]
  },
  {
    ...
    faqs: [
      ...
      { question: "What is the processing fee for a 10 Lakh loan?", answer: "Processing fees typically range from 0.5% to 2% of the loan amount (₹5,000 to ₹20,000). Always factor this into your upfront costs." }
    ]
  },
  {
    ...
    faqs: [
      ...
      { question: "Can I get a 20 Lakh loan with a 700 credit score?", answer: "Yes, 700 is considered a good score, but you might get slightly better interest rates if your score is above 750." }
    ]
  },
  ...
  // Tenure Comparison
  {
    ...
    faqs: [
      ...
      { question: "Does tenure affect the interest rate?", answer: "Sometimes banks offer slightly lower rates for shorter tenures as the risk of default over a shorter period is lower." }
    ]
  }
];
