...
async function pingSearchEngines() {
  ...
  const newUrls = [
    ...
    // New Tier 1 (2026-09-11)
    `${SITE_URL}/blog/education-loan-repayment-strategies-2026`,

    // New Tier 2 (2026-09-11)
    `${SITE_URL}/loan-types/sbi-education-loan-repayment-calculator`,
    `${SITE_URL}/loan-types/hdfc-education-loan-repayment-calculator`,
    `${SITE_URL}/loan-types/abroad-study-loan-emi-calculator`,
    `${SITE_URL}/loan-types/domestic-education-loan-emi-calculator`,
    `${SITE_URL}/scenarios/emi-calculator-25-lakh-education-loan`,
